  ...
  <div class="terms">
    <div class="container">
      <article class="box">
        ...
        <p>
          この利用規約（以下、「本規約」といいます。）は、橋濱幸太（以下、「運営者」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
        </p>

        <h2 class="heading">第1条（適用）</h2>
        <ol>
          <li>
        ...
        <h2 class="heading">第3条（ユーザーIDおよびパスワードの管理）</h2>
        <ol>
          <li>
        ...
        <h2 class="heading">第4条（利用料金および支払方法）</h2>
        <ol>
          <li>
        ...
        <h2 class="heading">第6条（本サービスの提供の停止等）</h2>
        <ol>
          <li>
        ...
        <h2 class="heading">第7条（利用制限および登録抹消）</h2>
        <ol>
          <li>
        ...
        <h2 class="heading">第8条（退会）</h2>
        <p>
          ユーザーは、運営者の定める退会手続により、本サービスから退会できるものとします。
        </p>

        <h2 class="heading">第9条（保証の否認および免責事項）</h2>
        <ol>
          <li>
